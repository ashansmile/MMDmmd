...
public class ServiceListActivity extends BaseActivity {
    ...
    private void getData() {
        ...
        list_service.add(new PersonService("默认服务器(demo)","","", "http://gzmian.com:5465/mmd/vision/RMIServlet"));
    ...
    private void initHead() {
        ...
        for (int i = 0; i < MMDApplication.activityManagers.size() ; i++) {
            if (MMDApplication.activityManagers.get(i) instanceof HomeActivity){
